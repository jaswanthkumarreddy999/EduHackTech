...
const EnrollmentManager = ({ course, isOpen, onClose }) => {
    ...
    const handleRemoveUser = async (userId) => {
        if (!window.confirm('Are you sure you want to unenroll this user? They will lose all progress.')) {
            return;
        }
    ...
    const filteredUsers = users.filter(enrollment =>
                        ...
                        {loading ? (
                            ...
                            <div className="space-y-3">
                                {filteredUsers.map((enrollment) => (
                                    <div key={enrollment._id} className="flex items-center justify-between p-4 bg-gray-50 rounded-xl hover:bg-white border border-transparent hover:border-gray-200 hover:shadow-sm transition">
                                        ...
                                        <div className="flex items-center gap-4">
                                            <div className="text-right hidden sm:block">
                                                ...
                                                <p className="text-xs text-gray-500">{enrollment.progress}%</p>
                                            </div>
